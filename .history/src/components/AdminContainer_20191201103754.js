          ...
          <React.Fragment>
            <nav className="dt pa2 pl6-l pr6-l w-100 border-box ph5-ns bg-white shadow-1-ns items-center flex-l flex-row-l">
              ...
              <div className="w-80-ns flex-l flex-row-l justify-end">
                ...
                <div className="w-100-s pl3-l pr3-l">
                  <h3 className="ma0">Số dư trong tài khoản</h3>
                  <div className="pa2 pl0">
                ...
                <div className="w-100-s pl3-l">
                  <h3 className="ma0">Phương thức kết nối</h3>
                  <div className="pa1">
            ...
            <Panel style={{ maxWidth: "900px" }}>
              ...
              <div className="flex bb pb3">
                <div className="w-100  w-50-l">
                  <h3>Store address: <HashColor hashee={adminAddress} networkId={networkId} /></h3>
...
const mapStateToProps = store => ({
  ...
  revokingDegree: getRevokingDegree(store),
...
const mapDispatchToProps = dispatch => ({
  ...
  revokeDegree: payload =>dispatch(revokeDegree(payload)),
